...
function Validate(validationFunction: { error: string | null }) {
  ...
  Mutation: {
    ...
    updateProfile: async (
      ...
      if (input.username !== undefined)
        Validate(ValidateUsername(input.username));

      if (input.email !== undefined) Validate(ValidateEmail(input.email));
      ...
      if (input.bio !== undefined) Validate(ValidateDescription(input.bio));
